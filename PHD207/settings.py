"""
Django settings for PHD207 project.
...
SECRET_KEY = 'django-insecure-b)!(rkqvy%no6)ta@$vvmyj@(vxrz$*^*vqz0$*i#)3g9*xhix'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['pythonanywhere.com', '1mos.pythonanywhere.com']]
...
INSTALLED_APPS = [
    'sauvegarde.apps.SauvegardeConfig',
    'rest_framework',
...
WSGI_APPLICATION = 'PHD207.wsgi.application'
